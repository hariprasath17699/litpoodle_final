        ...
        child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                children: <Widget>[
                  Input(
                    hintText: DecoLocalizations.of(context)
                        .localizedString("add_comment_name_hint"),
                  ...
                  Input(
                    hintText: DecoLocalizations.of(context)
                        .localizedString("add_comment_email_hint"),
                    margin: EdgeInsets.only(bottom: 10),
                  ...
                  Input(
                    hintText: DecoLocalizations.of(context)
                        .localizedString("add_comment_comment_hint"),
                    maxLines: 8,
        ...
        child: Container(
          ...
          child: ElevatedButton(
            ...
            child: Text(DecoLocalizations.of(context)
                .localizedString("add_comment_post")),
          ),
        ),
      ),
    );
