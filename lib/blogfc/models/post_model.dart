...
class PostModel {
  ...
  PostModel(this.id, this.category, this.title, this.body, this.image,
      this.date, this.link, this.bookmarked);

  factory PostModel.fromJson(Map<String, dynamic> json, CategoryModel category,
      {List bookmarks = const []}) {
