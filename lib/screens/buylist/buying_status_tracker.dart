...
class BuyingStatusTracker extends StatefulWidget {
  final bool showAppBar;
  Buylistproperty value;
  BuyingStatusTracker({
  ...
  @override
  _BuyingStatusTrackerState createState() => _BuyingStatusTrackerState();
}

class _BuyingStatusTrackerState extends State<BuyingStatusTracker> {
  bool isLoading = true;
...
/////////////////////////////
  Future<Map<String, dynamic>> Buyingstatuscall() async {
    ...
    var request = http.Request(
        'GET',
        Uri.parse(
            '$domain_url/api/user/auth/buylist_property_status/$cityname/$propid'));
    ...
    if (response.statusCode == 200) {
      print("result");
      print("Propert Status city $cityname");
      print("Propert Status city propid $propid");
                                                              ...
                                                              child: TextField(
                                                                ...
                                                                controller: TextEditingController.fromValue(
                                                                    TextEditingValue(
                                                                        ...
                                                                        text: snapshot.data["bit-offer"] ==
                                                                                ""
                                                                            ? " "
                                                                            : snapshot.data["bit-offer"]["status"].toString()
                                                                        // [
                                                                        // "status"]
                                                                        )),
                                                                cursorColor:
                                                                ...
                                                                controller: TextEditingController.fromValue(
                                                                    TextEditingValue(
                                                                        ...
                                                                        text: snapshot.data["bit-offer"] ==
                                                                                ""
                                                                            ? " "
                                                                            : snapshot.data["bit-offer"]["comments"].toString()
                                                                        // [
                                                                        // "status"]
                                                                        )),
                                                                minLines: 1,
                                                              ...
                                                              child:
                                                                ...
                                                                controller: TextEditingController.fromValue(
                                                                    TextEditingValue(
                                                                        ...
                                                                        text: snapshot.data["title-search"] ==
                                                                                ""
                                                                            ? " "
                                                                            : snapshot.data["title-search"]["status"].toString()
                                                                        // [
                                                                        // "status"]
                                                                        )),
                                                                //controller: loginemailtext,
                                                                ...
                                                                controller: TextEditingController.fromValue(
                                                                    TextEditingValue(
                                                                        ...
                                                                        text: snapshot.data["title-search"] ==
                                                                                ""
                                                                            ? " "
                                                                            : snapshot.data["title-search"]["comments"].toString()
                                                                        // [
                                                                        // "status"]
                                                                        )),
                                                                cursorColor:
                                                              ...
                                                              child:
                                                                ...
                                                                controller: TextEditingController.fromValue(
                                                                    TextEditingValue(
                                                                        ...
                                                                        text: snapshot.data["inspection"] ==
                                                                                ""
                                                                            ? " "
                                                                            : snapshot.data["inspection"]["status"].toString()
                                                                        // [
                                                                        // "status"]
                                                                        )),
                                                                cursorColor:
                                                                ...
                                                                controller: TextEditingController.fromValue(
                                                                    TextEditingValue(
                                                                        ...
                                                                        text: snapshot.data["inspection"] ==
                                                                                ""
                                                                            ? " "
                                                                            : snapshot.data["inspection"]["comments"].toString()
                                                                        // [
                                                                        // "status"]
                                                                        )),
                                                                minLines: 1,
                                                              ...
                                                              child:
                                                                ...
                                                                controller: TextEditingController.fromValue(
                                                                    TextEditingValue(
                                                                        ...
                                                                        text: snapshot.data["appraisal"] ==
                                                                                ""
                                                                            ? " "
                                                                            : snapshot.data["appraisal"]["status"].toString()
                                                                        // [
                                                                        // "status"]
                                                                        )),
                                                                //controller: loginemailtext,
                                                                ...
                                                                controller: TextEditingController.fromValue(
                                                                    TextEditingValue(
                                                                        ...
                                                                        text: snapshot.data["appraisal"] ==
                                                                                ""
                                                                            ? " "
                                                                            : snapshot.data["appraisal"]["comments"].toString()
                                                                        // [
                                                                        // "status"]
                                                                        )),
                                                                //controller: loginemailtext,
                                                              ...
                                                              child:
                                                                ...
                                                                controller: TextEditingController.fromValue(
                                                                    TextEditingValue(
                                                                        ...
                                                                        text: snapshot.data["insurance"] ==
                                                                                ""
                                                                            ? " "
                                                                            : snapshot.data["insurance"]["status"].toString()
                                                                        // [
                                                                        // "status"]
                                                                        )),
                                                                cursorColor:
                                                                ...
                                                                controller: TextEditingController.fromValue(
                                                                    TextEditingValue(
                                                                        ...
                                                                        text: snapshot.data["insurance"] ==
                                                                                ""
                                                                            ? " "
                                                                            : snapshot.data["insurance"]["comments"].toString()
                                                                        // [
                                                                        // "status"]
                                                                        )),
                                                                //controller: loginemailtext,
                                                                ...
                                                                controller: TextEditingController.fromValue(
                                                                    TextEditingValue(
                                                                        ...
                                                                        text: snapshot.data["closing"] ==
                                                                                ""
                                                                            ? " "
                                                                            : snapshot.data["closing"]["status"].toString()
                                                                        // [
                                                                        // "status"]
                                                                        )),
                                                                //controller: loginemailtext,
