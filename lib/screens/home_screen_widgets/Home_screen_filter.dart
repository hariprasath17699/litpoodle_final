...
import 'package:litpoodle/blogfc/helpers/search.dart';
import 'package:litpoodle/blogfc/models/category_model.dart';
...
class HomeScreenFilter extends StatefulWidget {
  ...
  bool highlowpricecolorfilter;
  bool sqftcolorfilter;
  bool bathcolorfilter;
  bool bedcolorfilter;
  bool yearscolorfilter;
  bool siglefamilycolorfilter;
  bool multifamilycolorfilter;
  bool mobilecolorfilter;
  bool landcolorfilter;
  bool otherscolorfilter;
  bool condocolorfilter;
  bool newconstructioncolorfilter;
  bool foreclosurefilter;
  bool poolfilter;
  bool waterfrontfilter;
  bool fireplacefilter;
  bool energyefficientfilter;
  bool washerdryerfilter;
  bool garagefilter;
  bool yesfilter;
  bool nofilter;
  HomeScreenFilter(this.siglefamilycolorfilter,this.multifamilycolorfilter,this.mobilecolorfilter,this.landcolorfilter,this.otherscolorfilter,this.newconstructioncolorfilter,this.foreclosurefilter,this.washerdryerfilter,this.garagefilter,this.yesfilter,this.energyefficientfilter,this.fireplacefilter,this.waterfrontfilter,this.poolfilter,this.yearscolorfilter,this.bedcolorfilter,this.bathcolorfilter,this.condocolorfilter,this.highlowpricecolorfilter,this.lowhighpricecolorfilter,this.nofilter,this.sqftcolorfilter);

  @override
  _HomeScreenFilterState createState() => _HomeScreenFilterState(  lowhighpricecolorfilter,
    highlowpricecolorfilter,
    sqftcolorfilter,
    bathcolorfilter,
    bedcolorfilter,
    yearscolorfilter,
    siglefamilycolorfilter,
    multifamilycolorfilter,
    mobilecolorfilter,
    landcolorfilter,
    otherscolorfilter,
    condocolorfilter,
    newconstructioncolorfilter,
    foreclosurefilter,
    poolfilter,
    waterfrontfilter,
    fireplacefilter,
    energyefficientfilter,
    washerdryerfilter,
    garagefilter,
    yesfilter,
    nofilter,);

  static _HomeScreenFilterState of(BuildContext context) =>
      context.findAncestorStateOfType<_HomeScreenFilterState>();
}
...
class _HomeScreenFilterState extends State<HomeScreenFilter> {
  ...
  bool yesfilter;
  bool nofilter;
  _HomeScreenFilterState(this.siglefamilycolorfilter,this.multifamilycolorfilter,this.mobilecolorfilter,this.landcolorfilter,this.otherscolorfilter,this.newconstructioncolorfilter,this.foreclosurefilter,this.washerdryerfilter,this.garagefilter,this.yesfilter,this.energyefficientfilter,this.fireplacefilter,this.waterfrontfilter,this.poolfilter,this.yearscolorfilter,this.bedcolorfilter,this.bathcolorfilter,this.condocolorfilter,this.highlowpricecolorfilter,this.lowhighpricecolorfilter,this.nofilter,this.sqftcolorfilter);
  ...
  Future<Map<String, dynamic>> profilecall() async {
    ...
    var request =
    http.MultipartRequest('POST', Uri.parse('https://clientdev.tagwebs.in/litpoodle/api/search/search_homes'));

    request.headers.addAll(headers);
    request.fields
        .addAll({'single_family' : siglefamilycolorfilter.toString()});
